...
function Week7() {
  ...
  return (
    <div className="w-100 bg-body-tertiary" style={{ minHeight: '100vh' }}>
      {!isAuth ? (
        ...
        <div className="container-fluid py-4 px-4">
          ...
          <div className="d-flex justify-content-end align-items-center bg-dark text-white p-3 mb-4 rounded shadow-sm gap-3">
            ...
            <Link to="/week7/admin/exchange" className="btn btn-outline-warning btn-sm d-flex align-items-center gap-1">
